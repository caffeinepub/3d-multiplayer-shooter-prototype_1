...
export class Backend implements backendInterface {
    ...
    async getPlayerState(arg0: string, arg1: Principal): Promise<PlayerState> {
        if (this.processError) {
            try {
    ...
    async getSessionStatus(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async joinSession(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async pickUpWeapon(arg0: string, arg1: string, arg2: Position): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.pickUpWeapon(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async respawnPlayer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.respawnPlayer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async shootPlayer(arg0: string, arg1: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.shootPlayer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePlayerPosition(arg0: string, arg1: Position): Promise<void> {
        if (this.processError) {
            try {
